...
//    this won't work no matter what I do even though the setup is identical to the vul web app which Does work so hardcoding the path in as a workaround
//private String policyFilePath;
    private String policyFilePath="src/main/resources/config/default-policy.json";
